...
class TaskDetailsScreen extends StatelessWidget {
  ...
  final Function(TaskEntities, bool) onTaskVerification;
          ...
          children: [
            ...
            Row(
              children: [
                ...
                _PriorityBadge(priority: TaskPriority.low, large: true),
              ],
            ),
            ...
            Wrap(
              ...
              children: [
                _MetaItem(
                  ...
                  color: _getStatusColor(TaskStatus.assigned),
                ),
                _MetaItem(
            ...
            if (task.location != null) ...[
              ...
              Text(
                ...
                '${task.location!.latitude.toStringAsFixed(4)}, ${task.location!.longitude.toStringAsFixed(4)}',
              ),
              const SizedBox(height: 24),
            ],
            ...
            _buildUserTile('Created By', AppUser(id: 'testing', name: 'testing', email: 'testing@gmail.com')),
            // if (assignee != null) _buildUserTile('Assigned To', assignee),
            _buildUserTile('Assigned To', AppUser(id: 'testing', name: 'testing', email: 'testing@gmail.com')),
            const SizedBox(height: 24),
